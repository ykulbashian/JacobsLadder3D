...
public class ColorPickerDialog 
	extends 
		Dialog 
	implements
		ColorPickerGradientView.OnColorChangedListener,
		View.OnClickListener {

	private ColorPickerGradientView mColorPicker;
	...
	private void setUp(int color) {
		...
		mColorPicker = (ColorPickerGradientView) layout.findViewById(R.id.color_picker_view);
		ImageButton mAcceptButton = (ImageButton) layout.findViewById(R.id.accept_color);
		ImageButton mCancel = (ImageButton) layout.findViewById(R.id.cancel);
