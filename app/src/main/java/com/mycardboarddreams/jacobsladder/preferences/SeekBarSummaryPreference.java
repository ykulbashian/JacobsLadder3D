...
public class SeekBarSummaryPreference extends SeekBarPreference implements OnPreferenceChangeListener {
    ...
    public int getInitialValue(int defaultValue){
    ...
    protected void onBindView(View view) {
        ...
        mSummary = String.valueOf(currentValue);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        setSummary(String.valueOf(seekBar.getProgress() + _min));
    }
	...
	public boolean onPreferenceChange(Preference preference, Object newValue) {
        preference.setSummary(String.valueOf(((Integer)newValue).intValue() + _min));
        return true;
	}
